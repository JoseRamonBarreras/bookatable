$("#promo_form").validate({
  ...
  messages: {
    ...
    title: {
      ...
      maxlength: "El titulo de la promoción no debe exceder los 80 caracteres."
    }
  }
});
$(".gambar").attr("src", base_url+"assets/images/upload-image-here.jpg");
...
$('#cropImageBtn').on('click', function (ev) {
  $uploadCrop.croppie('result', {
    ...
    $.ajax({
            ...
            type: "POST",
            data: {"image": resp, "path": "./assets/images/promos/"},
            beforeSend: function(){
